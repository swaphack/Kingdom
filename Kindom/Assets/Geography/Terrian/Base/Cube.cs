...
namespace Geography.Terrian
{
	...
	public class Cube : ModelBehaviour
	{
		...
		internal static Vector3 front_left_bottom = new Vector3 (0.5f, -0.5f, 0.5f);
		internal static Vector3 front_right_bottom = new Vector3 (-0.5f, -0.5f, 0.5f);
		internal static Vector3 front_left_top = new Vector3 (0.5f, 0.5f, 0.5f);
		internal static Vector3 front_right_top = new Vector3 (-0.5f, 0.5f, 0.5f);

		internal static Vector3 back_left_bottom = new Vector3 (-0.5f, -0.5f, -0.5f);
		internal static Vector3 back_right_bottom = new Vector3 (0.5f, -0.5f, -0.5f);
		internal static Vector3 back_left_top = new Vector3 (-0.5f, 0.5f, -0.5f);
		internal static Vector3 back_right_top = new Vector3 (0.5f, 0.5f, -0.5f);
		...
		private int[] GetRangeArray (int[] srcArray, int startIndex, int endIndex)
		{
